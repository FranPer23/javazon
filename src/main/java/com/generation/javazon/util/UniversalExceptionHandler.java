package com.generation.javazon.util;
...
public class UniversalExceptionHandler {
    ...
    public ResponseEntity<?> gestisciEccezioneConversioneJson(HttpMessageNotReadableException e)// catch(HttpMessageNotReadableException
                                                                                                // e)
    {
